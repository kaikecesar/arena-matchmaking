...
import { authStorage } from '@/views/auth/storage'

// Context
import { AuthContext } from '@/views/auth/context/AuthContext'

// Utils
import { authProviderReducer } from '@/views/auth/context/authProvider.reducer'
import { createAuthProviderInitialState } from '@/views/auth/context/authProvider.state'
...
// Types
import { AuthStatus, type AuthContextValue, type AuthProviderProps } from '@/views/auth/context/AuthContext.types'
import type { LoginPayload, RegisterPayload } from '@/views/auth/types'
